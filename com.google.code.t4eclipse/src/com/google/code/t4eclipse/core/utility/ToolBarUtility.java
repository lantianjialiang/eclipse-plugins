...
public class ToolBarUtility {
	...
	public static String getActionContributioItemClass(Object data) {
		ActionContributionItem ci = (ActionContributionItem) data;
	...
	public static ICoolBarManager getEclipseCoolBarForE4() {
		Shell shell = PlatformUI.getWorkbench().getActiveWorkbenchWindow()
				.getShell();
		Object data = shell.getData();

		if ((data instanceof WorkbenchWindow)) {
			WorkbenchWindow ww = (WorkbenchWindow) data;
			return ww.getCoolBarManager2();
		}
